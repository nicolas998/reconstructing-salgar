...
For the technically inclined reader, the hydrologic model and sub-models are written in Fortran 90, and the interface to the model, pre-process, and post-process tools are in python 2.7. The Fortran code is warped to python using \textbf{f2py} \citep{Peterson2009} and it is publicly available under the Watershed Modelling Framework \textbf{WMF} in a web repository (\href{https://github.com/nicolas998/WMF.git}{\textbf{GitHub}}). \\
